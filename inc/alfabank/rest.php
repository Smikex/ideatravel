...
define('GATEWAY_URL', 'https://test.paymentgate.ru/testpayment/rest/'); #необходимо заменить!  #Should be replaced!
define('RETURN_URL', 'http://ideatravelrussia.com/wp-content/themes/ideatravel/inc/alfabank/rest.php');          #необходимо заменить!  #Should be replaced!
